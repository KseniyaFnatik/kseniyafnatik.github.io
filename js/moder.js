class ModerManager {
    ...
    loadData() {
        ...
        // Загружаем вакансии (пока заглушка)
    ...
    renderResumes() {
        ...
        const search = document.getElementById('resumeSearch').value.toLowerCase();
        ...
        if (search) {
            filteredResumes = filteredResumes.filter(resume =>
                ...
                (resume.personal.email && resume.personal.email.toLowerCase().includes(search))
            );
        }
        ...
        container.innerHTML = filteredResumes.map(resume => `
            <div class="moderation-item ${resume.moderationStatus}">
                ...
                <div class="item-content">
                    <p><strong>Соискатель:</strong> ${resume.personal.fullName}</p>
                    <p><strong>Контакты:</strong> ${resume.personal.phone}, ${resume.personal.email}</p>
    ...
    renderVacancies() {
        ...
        const filter = document.getElementById('vacancyFilter').value;
        const search = document.getElementById('vacancySearch').value.toLowerCase();
    ...
    searchResumes(query) {
        // Просто перерисовываем список с учетом поиска
        this.renderResumes();
    }
